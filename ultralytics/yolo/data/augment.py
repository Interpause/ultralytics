    ...
    def __init__(self, p=1.0):
        ...
        try:
            ...
            T = [
                # A.Blur(p=0.01),
                # A.MedianBlur(p=0.01),
                A.AdvancedBlur(p=0.15, blur_limit=(5, 17), noise_limit=(0.0, 2.0), beta_limit=(0.0, 4.0)),
                # A.ToGray(p=0.01),
                A.CLAHE(p=0.2),
                A.MotionBlur(p=0.15, blur_limit=(5, 17)),
                # A.RandomBrightnessContrast(p=0.0),
                # A.RandomGamma(p=0.0),
                A.ImageCompression(p=0.1, quality_lower=20, quality_upper=50),
                A.GaussNoise(p=0.25, per_channel=True, var_limit=(1000.0, 5000.0)),
